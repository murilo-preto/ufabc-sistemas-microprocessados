...
/**
  ...
  *
  * notas: J Ranhel
  *   UART (PA9 tx/ PA10 rx) configurada para operar por INTERRUPÇÃO
  *   - para ativar a UART1 para receber dados e requisitar interrupção:
  *   RX HAL_UART_Receive_IT(&huart1, BufIN, sizeBuffs);
  *   - para transmitir o conteúdo do buffer de dados pela UART1:
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  // aqui você pode tratar as mensagens recebidas pela UART
